<template>
  <div class="content-list">
    ...
    <AntdCart v-if="wishData && wishDataStaus" :thingList="wishData" @getWithList="getWishThingList()"></AntdCart>
  </div>
</template>
...
import AntdCart from '/@/views/index/components/AntdCart.vue'
